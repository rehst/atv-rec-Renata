...
async function redesSociaisFavoritasMinhaEscola() {
    ...
    if (dadosLocaisString) {
        ...
        const url = 'https://script.google.com/macros/s/AKfycbyfkuh3lClumLkQQ8k87mgusELqDAW7Bb34et5hB93D6rEyllQrPsFhuA2cwy_vB7px/exec'
...
function processarDados(dados) {
    ...
    const layout = {
        ...
        height: 700,
        title: {
            text: 'Redes sociais que as pessoas da minha escola mais utilizam',
            x: 0,
            font: {
